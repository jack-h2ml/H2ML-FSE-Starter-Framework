...
/* harmony import */ var _AnimateOnScroll_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AnimateOnScroll.scss */ "./src/view_dependencies/AnimateOnScroll/AnimateOnScroll.scss");
...
class H2mlAnimateOnScroll {
  ...
  static #observerCallback = entries => {
    entries.forEach(entry => {
      ...
      //
      const animateDirectionFilter = !!(0,_h2ml_switchexpression__WEBPACK_IMPORTED_MODULE_0__.switchExp)([['forwards', !scrollingDirection], ['backwards', scrollingDirection], ['both', isRamping]]).eval(animateDirection).find(res => res === true);
      //
      if (isShown !== !!isShown) {
